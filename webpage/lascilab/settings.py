"""
Django settings for lascilab project.
...
SECRET_KEY = 'j=wsjq)wfuuv$=^ap7*&r4h$ciaz^rfc+_a!fglm1x(9u7#!z8'
...
ADMINS = [
    ('Network Lab','laboratorio.redesysd@correounivalle.edu.co'),
]
...
WSGI_APPLICATION = 'lascilab.wsgi.application'
